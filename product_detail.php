    ...
    <section>
        <div class="pageintro">
            ...
            <div class="pageintro-body">
                <h1 class="pageintro-title">Chi Tiết Sản Phẩm</h1>
                    ...
                    <div class="product-detail">
                        <div class="shop-product p-t-25">
                            ...
                            <div class="product-body">
                                ...
                                <?php
                                    ...
                                    <?php } ?>
                                <span class="price"><?php echo number_format($product['selling_price'], 0, ',', '.')." VNĐ"; ?></span><br><br>
                                <div class="product-button">
                                    ...
                                    <a href="cart.php?action=add&id=<?php echo $product['product_id']?>" class="add-to-cart">Thêm vào giỏ hàng</a>
                                </div>
                                <div class="product-available">
                                    <span>Trạng Thái :</span>
                                    <span style="color: orangered">Còn Hàng</span>
                                </div>
                        ...
                        <div class="au-tabs">
                            <ul class="nav nav-tabs">
                                ...
                                <li>
                                    <a data-toggle="tab" href="#review-tab">Bình Luận</a>
                                </li>
                            </ul>
                            <div class="tab-content">
                                ...
                                <div id="review-tab" class="tab-pane">
                                    <div class="fb-comments" data-href="http://localhost/FurnitureStore/product_detail.php?pid=<?php echo $product['product_id'];?>" data-width="1170" data-numposts="5"></div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="grid-product">
                                                <div class="image bg-lightblue">
                                                    ...
                                                    <div class="addcart">
                                                        <a href="cart.php?action=add&id=<?php echo $rows['product_id']?>">Thêm vào giỏ hàng</a>
                                                    </div>
                                                </div>
                                                <a href="#" class="name"><?php echo $rows['product_name']?></a>
                                                <div class="price"><?php echo number_format($product['selling_price'], 0, ',', '.')." VNĐ"; ?></div>
                                            </div>
                                        </div>
                                        <?php
                                    }
